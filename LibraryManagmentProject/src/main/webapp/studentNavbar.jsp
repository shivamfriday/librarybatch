...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<!-- Navbar brand -->
			<a class="navbar-brand" href="<%=request.getContextPath()%>/studentWelcome.jsp">Library<b style="color: green">Mangament</b></a>
...
<%-- 			<a class="navbar-brand mt-2 mt-lg-0" href="<%=request.getContextPath()%>/studentWelcome.jsp">Library
			...
			<div class="d-flex align-items-center">
				<c:choose>
					<c:when test="${empty sessionScope.studentObj }">
							...
							<li class="nav-item text-center" id="signup-btn"><a href="#"
								class="nav-link" data-toggle="modal" data-target="#"><span
									...
									class="d-none d-sm-inline d-xl-block px-1"><c:out
											value="${studentObj.getStudentId()}" /> </span></a></li>
					...
					<c:otherwise>
						...
						<%-- <a type="button" href="<%=request.getContextPath()%>/logout.jsp"
