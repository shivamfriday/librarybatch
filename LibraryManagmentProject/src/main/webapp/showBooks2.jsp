...
<!-- <div class="alert alert-success" role="alert">
  This is a success  it out
</div> -->
<%-- <% String status = request.getParameter("result");%> --%>

<%-- <input type="hidden" id="resultStatus" value="<%=status%>"> --%>

<div class="row row-cols-3 g-4 justify-content-center" style="margin-top:20px; ">
			...
			<div class="card h-100" >
				...
				<div class="card-body">
					...
					<button type="button" class="btn btn-primary"
						data-modal-target="#modal" id="${libObj.getId()}" value="${item.getBookId()}">Assign
						Book</button>
					<!-- 					<button type="button" class="btn btn-primary"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" value="${libObj.getId()}" name="librarianId"></input>
				</div>
